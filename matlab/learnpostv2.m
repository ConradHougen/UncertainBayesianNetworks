function [m,r,aout] = learnpostv2(nin)

Na = nin.Na; % Number of times both x and y are observed
Tx = nin.Tx; % Number of times x is observed
Ny = nin.Ny; % Number of times only y is observed
Tyx = nin.Tyx; % x = True and y is observed
Tynx = nin.Tynx; % x = False and y is observed
nx = nin.nx; % Number of times x = True
nyx = nin.nyx; % Number of times y = True && x = True
nynx = nin.nynx; % Number of times y = True && x = False
ny = nin.ny; % Number of times y = True when x not observed
