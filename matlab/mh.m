function [m,cov,theta0] = mh(meta,val)
...
%calculate the Dirichlet parameters for all the conditional probabilities
%(for the case where the parent and child values are fully observed)
theta0 = sum(hits,1)'+1;
