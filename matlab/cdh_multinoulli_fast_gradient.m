% Optimized gradient computation for multinoulli case
function [scores,grad,pe] = cdh_multinoulli_fast_gradient(val,fpidx,circ,meta,Nminibatch,t)

    % DO NOT USE yet: need gradient computation logic for multinoullli case
    fprintf(1, 'ERROR: Not implemented');
    return;
